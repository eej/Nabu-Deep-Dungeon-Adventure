...
;					db #02,#80,#20,#81,#06,#82,#ff,#83,#03,#84,#36,#85,#07,#86,#01,#87,#00,#8e,#00,#40
					db #00,#80 ; not mode 2
                    db #e2,#81 ; 16k, mode 0, screen enabled, gen interrupts, 16x16 sprites
                    db #06,#82 ; PNT to 0x1800
                    db #80,#83 ; CT starting at 0x2000
                    db #00,#84 ; PGT starting at 0x0
                    db #36,#85 ; sprite attribute table 0x1b00
                    db #07,#86 ; sprite gen table at 0x3800
...
; EEJ
            ...
            ; set full colour table to black and white
            ld hl, 0x2000
            ld bc, 32
            ld a, 0xf1
            call filvrm
...
;            ret     z
;
;            ld de,BUFFER+32*8   ; guarda la direcci�n de la columna "32"
